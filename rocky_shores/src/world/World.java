...
public class World {	//contains all global vars and world offset to simulate camra
	public boolean IS_DISPLAY_GUI;
	public float FOV, FOV_ZOOM_VEL;
	public final float FOV_NORM = 45.0f;
	public final int START_WOOD = 15, START_ROCK = 15, START_FOOD = 10;
	public int WOOD = START_WOOD, ROCK = START_ROCK, FOOD = START_FOOD;
